...
int main(void)
{
    ...
    int checksum, digit, digit_sum, digit_times_two,
     digit_times_two_sum, digit_over_ten_sum, digit_first_digit, digit_second_digit;
    checksum = digit = digit_sum = digit_times_two = digit_times_two_sum =
     digit_over_ten_sum = digit_first_digit = digit_second_digit = 0;
